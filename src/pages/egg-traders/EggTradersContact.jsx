    ...
    <>
      ...
      <div ref={ref}>
              ...
              <div className="et-form-card reveal">
                <form onSubmit={handleSubmit}>
                  ...
                  <button type="submit" disabled={submitting} style={{
                    ...
                    background: 'linear-gradient(120deg,#A8862F,#C8A24A 55%,#F2E7C9)', color: '#060e1a',
                    ...
                    onMouseEnter={(e) => { if (!submitting) { e.target.style.transform = 'translateY(-2px)'; e.target.style.boxShadow = '0 14px 32px rgba(200,162,74,0.45)'; } }}
                    onMouseLeave={(e) => { e.target.style.transform = 'none'; e.target.style.boxShadow = '0 10px 24px rgba(200,162,74,0.35)'; }}
                  >
        ...
        <style>{`
          ...
          .et-ci-icon { width: 44px; height: 44px; border-radius: 12px; background: rgba(200,162,74,0.12); border: 1px solid rgba(200,162,74,0.25); display: flex; align-items: center; justify-content: center; color: #C8A24A; flex-shrink: 0; }
          .et-ci-label { font-size: 11px; color: rgba(255,255,255,0.5); text-transform: uppercase; letter-spacing: .06em; font-weight: 600; margin-bottom: 4px; }
          .et-ci-value { font-size: 14.5px; color: #FFFFFF; font-weight: 600; }
          .et-form-card { background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 32px; padding: 42px; box-shadow: 0 20px 50px rgba(0,0,0,0.35); backdrop-filter: blur(12px); }
          .et-form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 18px; }
          .et-f-group { margin-bottom: 20px; }
          .et-f-label { display: block; font-size: 12.5px; font-weight: 600; color: #E5C87A; margin-bottom: 8px; }
          .et-f-input { width: 100%; padding: 13px 16px; border: 1.4px solid rgba(255,255,255,0.14); border-radius: 9px; font-size: 13.5px; font-family: 'Inter',sans-serif; color: #FFFFFF; background: rgba(255,255,255,0.05); transition: border-color .25s, box-shadow .25s; }
          .et-f-input::placeholder { color: rgba(255,255,255,0.35); }
          .et-f-input:focus { outline: none; border-color: #7FB6F2; box-shadow: 0 0 0 3px rgba(127,182,242,0.15); }
          ...
          select.et-f-input option { background: #0B2545; color: #FFFFFF; }
          textarea.et-f-input { resize: vertical; min-height: 90px; }
          .et-form-note { font-size: 12px; color: rgba(255,255,255,0.5); text-align: center; margin-top: 14px; }
