...
export default function EggTradersContact() {
  ...
  return (
    <>
      <EggTradersPageBanner title={banner?.title || 'Contact Us'} subtitle={banner?.subtitle || ''} />
      <div ref={ref}>
              ...
              <div className="et-form-card reveal">
                <form onSubmit={handleSubmit}>
                  ...
                  <button type="submit" disabled={submitting} style={{
                    ...
                    onMouseEnter={(e) => { if (!submitting) { e.target.style.transform = 'translateY(-2px)'; e.target.style.boxShadow = '0 14px 32px rgba(247,107,13,0.45)'; } }}
                    onMouseLeave={(e) => { e.target.style.transform = 'none'; e.target.style.boxShadow = '0 10px 24px rgba(247,107,13,0.35)'; }}
                  >
